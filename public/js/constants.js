define([
  ...
  Constants.CONTROLS_TEXT_TEXT =
    "Press Arrow Left and Right to move, press Space to fire.";
  ...
  Constants.ALL_SOUNDS = [
    Constants.SHIP_DESTROYED_SOUND,
    Constants.KILL_ENEMY_SOUND,
    Constants.FIRING_SOUND,
  ...
  Constants.GAME_OVER_TEXT_Y = 320;
  Constants.GAME_OVER_TEXT_TEXT = "Game Over. Press Enter to Restart";
  Constants.GAME_OVER_TEXT_COLOR = "#ecf0f1";
  Constants.GAME_OVER_TEXT_FONT = "30px Georgia";
  Constants.GAME_OVER_START_KEY = 13;
